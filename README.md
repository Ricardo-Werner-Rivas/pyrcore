# `pyrcore`
[Python]:https://img.shields.io/badge/python-3.14.7-&
[Supported Python]:https://img.shields.io/badge/python->=3.14.7-&?label=CPython
...
|About|Information|
|---|---|
|Development Python version|[![Python]](https://www.python.org/downloads/release/python-3147/)|
...
* ~~Support for R `ts` class (`TimeSeries`)~~ (stable)
* <ins>Support for R `mts` class (multivariate time-series)</ins> (development)
